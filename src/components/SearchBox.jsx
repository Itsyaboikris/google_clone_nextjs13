...
const SearchBox = () => {
	...
	return (
		<form  onSubmit={handleSubmit} className='flex border border-gray-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-growmax-w-3xl items-center'>
			<input type="text" className='w-full focus:outline-none ' onChange={(e) => setTerm(e.target.value)} value={term} />
			<RxCross2 className='text-2xl text-grey-500 cursor-pointer sm:mr-2' onClick={() => setTerm("")} />
